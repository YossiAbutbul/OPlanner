  ...
  return (
    <div className="homework-table-wrap">
      ...
      <HomeworkModal
        ...
        onSave={(id, name, dueDate, status, year, semester, course, ignoreOverdue, startTime, endTime) => {
          if (!name || !dueDate) {
            alert("Please fill in all fields before saving.");
            return;
          }
          addHomework(id, name, dueDate, status, year, semester, course, ignoreOverdue, undefined, startTime, endTime);
          setModalOpen(false);
          setEditHomework(null);
        } }
